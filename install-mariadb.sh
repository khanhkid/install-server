...
# Import repo key
sudo apt-key adv --recv-keys --keyserver hkp://keyserver.debian.com:80 0xcbcb082a1bb943db

# Add repo for MariaDB
sudo add-apt-repository "deb [arch=amd64,i386] http://mirrors.accretive-networks.net/mariadb/repo/$MARIADB_VERSION/debian trusty main"
